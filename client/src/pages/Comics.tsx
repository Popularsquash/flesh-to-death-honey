...
export default function Comics() {
  const comics = [
    ...
    },
    {
      ...
      date: "Coming Soon",
      coverImage: "https://files.manuscdn.com/user_upload_by_module/session_file/104679889/GGOnroDCkoItALsr.jpg",
      pages: 0,
      status: "COMING SOON",
      description: "A rival gang rolls into town wearing yellow and black. They call themselves the Yellowjackets. They think they run these roads. Buzzkill and the crew have other plans.",
    },
  ];
